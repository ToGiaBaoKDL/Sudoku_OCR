...
def extract_angle_orientation(board, result_ocr, padding=5):
    ...
    for line in result_ocr:
        for detection in line:
            ...
            ocr = PaddleOCR(use_angle_cls=True, lang="ch", rec_batch_num=2, det_db_box_thresh=0.35)
...
def ocr_sudoku(sudoku_board, debug=False):
    ...
    # Initialize OCR engine
    ocr = PaddleOCR(use_angle_cls=True, lang="ch", det_db_box_thresh=0.35, rec_batch_num=2)
